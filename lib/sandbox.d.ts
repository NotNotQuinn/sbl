...
declare type SupibotParameterParsedType<T extends SupibotParameterType> = T extends "string" ? string : T extends "number" ? number : T extends "boolean" ? boolean : T extends "date" ? Date : T extends "object" ? Record<string, JSONifiable> : T extends "regex" ? RegExp : string | number | boolean | Date | Record<string, JSONifiable> | RegExp;
...
declare interface SupibotDankDebugUtils {
	 ...
	 */
	parseParameter(value: string, type: SupibotParameterType): SupibotParameterParsedType<SupibotParameterType> | null;
